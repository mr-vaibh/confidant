"""
Django settings for confidant project.
...
SECRET_KEY = 'django-insecure-2^4&e!_@7%moun$hcz*lq-lp63e)=z711p5xe+y=s&q)3a!7qo'
...
WSGI_APPLICATION = 'confidant.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'confidant'),
        'USER': os.environ.get('DB_USERNAME', 'postgres'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'root321'),
...
DJOSER = {
    ...
    'ACTIVATION_URL': 'auth/account/activation?uid={uid}&token={token}',
...
# Celery settings for billing usage
